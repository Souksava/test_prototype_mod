...
<body>
                            ...
                            <div class="navbar-bottom-menu">
                                ...
                                <div class="navbar-collapse justify-content-center collapse"
                                    ...
                                    <ul class="navbar-nav d-lg-flex justify-content-between align-items-center">
                                        ...
                                        <li class="dropdown nav-item">
                                            <a data-toggle="dropdown" class="dropdown-toggle nav-link" href="#">ແຜນ<b
                                                    class="caret"></b></a>
                                            <ul class="dropdown-menu">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="image/slidea.jpg" alt="First slide" height="600px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="image/slideb.jpg" alt="Second slide" height="600px">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="image/slidec.jpg" alt="Third slide" height="600px">
    </div>
  </div>
...
ແຜນປີ</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-6 grid-margin mb-5 mb-sm-2" style="margin-top:30px">
                                <div class="position-relative image-hover">
                                    <img src="image/unnamed.jpg" class="img-fluid" alt="world-news" />
                                    <span class="thumb-title"><span class="fs-10 mr-1">11/01/2021</span></span>
                                </div>
